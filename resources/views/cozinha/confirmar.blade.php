...
@section('conteudo')
    <div class="text-center" style="padding: 6em 0 10em 0;">
        <h4>
            ...
            <div>Deseja realmente mudar a situação do pedido para <b>Pronto</b>?</div>
        </h4>
        <br>
        <form method="POST" action="{{url('cozinha/pedido-pronto/'.$id_pedido)}}">
            {{ @csrf_field() }}
            ...
            <a href="{{ url('cozinha/monitor') }}" class="btn btn-danger" style="text-shadow: 5px 5px 5px rbga(0,0,0,0.5); box-shadow: 5px 5px 5px rgba(0,0,0,0.5);">
