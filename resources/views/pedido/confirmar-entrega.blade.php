...
@section('conteudo')
    <div class="text-center" style="padding: 6em 0 10em 0;">
        ...
        <br>
        <form method="POST" action="{{url('pedido/salvar-entrega/'.$id_pedido.'/'.$tipo)}}">
            {{ @csrf_field() }}
            ...
            <a href="{{ url('pedido/historico-pedido/'. $id_pedido.'/'.$tipo) }}" class="btn btn-danger" style="text-shadow: 5px 5px 5px rbga(0,0,0,0.5); box-shadow: 5px 5px 5px rgba(0,0,0,0.5);">
